...
int main(void)
{
    ...
    if (sum_main > sum_sec)
        printf("Diagonal principal teve maior volume.\n");
    else if (sum_sec > sum_main)
        printf("Diagonal secundaria teve maior volume.\n");
    else
        printf("As duas diagonais tiveram igual volume.\n");
    return 0;
}
